...
/* ELFOSABI_ARM_AEABI in elf.h but not readelf source */
...
const char *getMachineName (Elf64_Half e_machine)
{
	...
	case EM_PARISC:return "HPPA";
		/* EM_VPP500 in elf.h, not readelf source */
	...
	case EM_RH32:return "TRW RH32";
		/* EM_RCE (39) in elf.h, not readelf source */
	...
	case EM_PJ:return "picoJava";
		/* EM_OPENRISC (92) in elf.h, not readelf source */
	case EM_OPENRISC:return "OpenRISC 32-bit embedded processor";
		/* EM_ARC_A5 (93) in elf.h, not readelf source */
